...
public class XibaoPlusPlusMusic {
    public static RegistryEntry.Reference<SoundEvent> XIBAO_SOUND_EVENT = registerReference(Identifier.of("xibaopp", "xibao"));
    public static MusicSound XIBAO_MUSIC = new MusicSound(XIBAO_SOUND_EVENT, 0, 0, true);
    public static RegistryEntry.Reference<SoundEvent> BEIBAO_SOUND_EVENT = registerReference(Identifier.of("xibaopp", "beibao"));
